...
namespace NiumaUI.AudioBridge
{
    /// <summary>
    /// 单个 UI 视图的音频覆盖配置。
    /// ViewId 填 UIToolkitUIManager.OpenView 使用的视图 ID，例如 DialogueWindow、InventoryPanel。
    /// </summary>
    [Serializable]
    public sealed class UIViewAudioCueSet
    {
        [Tooltip("UI 视图 ID。填写 UIToolkitUIManager.OpenView / UIToolkitViewRegistrySO 中配置的 ViewId，例如 DialogueWindow。")]
